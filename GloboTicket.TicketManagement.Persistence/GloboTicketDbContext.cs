...
namespace GloboTicket.TicketManagement.Persistence
{
    public class GloboTicketDbContext: DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            //The ToTable method is applied to an entity to specify the name of the database table that the entity should map to.
            modelBuilder.Entity<Category>().ToTable("Categories");
            modelBuilder.HasDbFunction(typeof(GloboTicketDbContext).GetMethod(nameof(GetAllCategories)))
           .HasName("ufn_GetAllCategories").HasSchema("GloboTicket");
        }
        //A queryable function must be mapped to a table-valued function
        public IQueryable<Category> GetAllCategories() => FromExpression(() => GetAllCategories());
